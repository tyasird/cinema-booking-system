                        ...
                        <table class="table table-striped">
                            ...
                            @foreach ($sales as $sale)
                                <tr>
                                    ...
                                    <td>{{ isset($sale->showtime->movie->movie_name) ? $sale->showtime->movie->movie_name : '-' }}</td>
                                    <td>
                                        <a href="#"
                                           onclick="PopupCenter('show_sales?id='+ {{$sale->id}}, 'Yazdır', 500, 500)">
                                            <i class="fa fa-print"></i> Bilet Yazdır</a>
                                        <a href="#" data-saleid="{{$sale->id}}"
                                           class="delete_sales"><i class="fa fa-minus-square"></i> Sil</a>
                                       <!--
                                        @if ($sale->status <>2)
                                            <a href="#" data-saleid="{{$sale->id}}"
                                               class="cancel_sales"><i class="fa fa-minus-square"></i> İptal Et</a>
                                        @else
                                            İptal Edildi
                                        @endif
                                        -->
